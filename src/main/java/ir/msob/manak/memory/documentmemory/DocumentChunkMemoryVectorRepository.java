...
@Repository
public class DocumentChunkMemoryVectorRepository extends VectorCrudRepository {

    protected DocumentChunkMemoryVectorRepository(VectorStoreFactory vectorStoreFactory) {

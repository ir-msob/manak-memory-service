...
@Testcontainers
@CommonsLog
public class MemoryCharacteristicRestResourceIT
        extends BaseCharacteristicCrudRestResourceTest<Memory, MemoryDto, MemoryCriteria, MemoryRepository, MemoryService, MemoryDataProvider, MemoryService, MemoryCharacteristicCrudDataProvider>
    ...
    public void beforeEach() {
        ...
        MemoryCharacteristicCrudDataProvider.createNewChild();
    }
    ...
    public Class<? extends BaseResource<String, User>> getResourceClass() {
        return MemoryCharacteristicRestResource.class;
    }
}
